...
//
#ifdef OF22
Foam::solverPerformance Foam::PBiCG_accel::solve
#else
...
#else
    Foam::lduMatrix::solverPerformance solverPerf
#endif
            (
...
//   {
        ...
        */
        ...
        if ( matrix_type == CSR )
        {
            ...
            switch ( precond_type )
            {
                case SI_AMG:
                {
                    ...
                    solver_result = si_gshcsrbicgstabamg(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_AINV:
                {
                    ...
                    solver_result = si_gshcsrbicgstabainv(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_AINV_SC:
                {
                    ...
                    solver_result = si_gshcsrbicgstabainvscaled(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_AINV_NS:
                {
                    ...
                    solver_result = si_gshcsrbicgstabainvnsym(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_DIAGONAL:
                {
                    ...
                    solver_result = si_gshcsrbicgstabdiagonal(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_VOID:
                {
                    ...
                    solver_result = si_gshcsrbicgstabvoid(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                default:
                {
                    Foam::FatalError << "Wrong preconditioner" << Foam::exit(Foam::FatalError, -1);
                }
                break;
        ...
        else if ( matrix_type == CMR )
        {
            ...
            switch (precond_type)
            {
                case SI_DIAGONAL:
                {
                    ...
                    solver_result = si_gshcmrbicgstabdiagonal(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
                ...
                case SI_VOID:
                {
                    ...
                    solver_result = si_gshcmrbicgstabvoid(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
    ...
    #else
        //classic part
        Foam::FatalError << "Error: There is no classic version of PBiCG" << Foam::exit(Foam::FatalError, -1) ;
        ...
        if(matrix_type == CSR)
        {
            ...
            case SI_AMG:
                {
                    ...
                    solver_result = si_gdhcsrbicgstabamg(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_AINV:
            {
                ...
                solver_result = si_gdhcsrbicgstabainv(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_AINV_SC:
            {
                ...
                solver_result = si_gdhcsrbicgstabainvscaled(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_AINV_NS:
            {
                ...
                solver_result = si_gdhcsrbicgstabainvnsym(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_VOID:
            {
                ...
                solver_result = si_gdhcsrbicgstabvoid(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_DIAGONAL:
            {
                ...
                solver_result = si_gdhcsrbicgstabdiagonal(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_DIAGONAL:
                {
                    ...
                    solver_result = si_gdhcmrbicgstabdiagonal(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
            ...
            case SI_VOID:
                {
                    ...
                    solver_result = si_gdhcmrbicgstabvoid(matrix_handler,pgpu_X, pgpu_B, preconditioner_handler, &n_iter, &eps );
